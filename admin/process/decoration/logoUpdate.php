...
<?
if($_FILES['logo']['name']==""){echo"<script>alert('ยังไม่เลือกรูปภาพ');history.back();</script>";exit;}
//รับค่า
...
unlink("../../../image/".$rowDelete['logo']);
//อัพเดทข้อมูล
$sqlUpdate="UPDATE decoration SET logo='$logo'";
mysql_query($sqlUpdate)or die(mysql_error());
//อัพโหลดภาพ
if(move_uploaded_file($_FILES['logo']['tmp_name'],"../../../image/".$logo)){
  $error="";
}
//ถ้าอัพโหลดไม่ได้
else{
