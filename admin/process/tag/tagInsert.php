...
<? 
if($_REQUEST['name']==""){echo"<script>alert('ยังกรอกข้อมูลไม่ครบ');history.back();</script>";exit;}
$name=$_REQUEST['name'];
$link=$_REQUEST['link'];
include('../../../process/connect.php');
$sql="INSERT INTO tag(name, link, insert_date, last_update) VALUES(\"$name\", '$link', now(), now())";
