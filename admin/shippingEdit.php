<?
if(empty($_REQUEST['id'])){echo"<script>window.location='shipping.php';</script>";exit;}
session_start();
?>
...
<div style="width:962px;margin:20px auto 0 auto;text-align:right;">
  <input type="button" value="กลับ" onclick="window.location='shipping.php'"/>
</div>
<table class="data" style="margin-top:10px;" align="center" cellpadding="10" cellspacing="0" >
  <tr>
    <th class="header" colspan="2" >แก้ไขวิธีการจัดส่ง</th>
  </tr>
  <tr>
    <td colspan="2">
<form action="process/shipping/shippingUpdate.php" method="post" name="shipping">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="100">วิธีการจัดส่ง</td>
    <td><input name="option" type="text" style="width:300px;" value="<?=$row['option']?>"/></td>
  </tr>
  <tr>
    <td>ราคา</td>
    <td><input name="price" type="text" style="width:80px;" value="<?=$row['price']?>"/></td>
  </tr>
  <tr>
