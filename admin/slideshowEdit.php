...
<div style="width:962px;margin:20px auto 0 auto;text-align:right;">
  <input type="button" value="กลับ" onclick="window.location='slideshow.php'"/>
</div>
<table class="data" style="margin-top:10px;" align="center" cellpadding="10" cellspacing="0" >
  <tr>
    <th class="header">แก้ไขภาพสไลด์
<div style="float:right;">
  <a href="process/slideshow/slideshowDelete.php?id=<?=base64_encode($row['id'])?>" onclick="return confirm('ลบภาพนี้ ?')"><img src="image/icon-bin.png"class="action" title="ลบ"/></a>
</div>
    </th>
  </tr>
  <tr>
    <td colspan="2">
<form action="process/slideshow/slideshowUpdate.php" method="post" enctype="multipart/form-data" name="slideshow">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="100">ชื่อภาพ</td>
    <td><input name="title" type="text" value="<?=$row['title']?>" style="width:250px;"/></td>
  </tr>
  <tr>
    <td>ลิงค์</td>
    <td><input name="link" type="text" value="<?=$row['link']?>" style="width:250px;"/></td>
  </tr>
  <tr>
    <td>ภาพ</td>
    <td>
      <img src="../slideshow/<?=$row['image']?>" class="slideshow" title="<?=$row['title']?>" style="margin-bottom:10px;"/><br/>
      <input name="slideshow" type="file"/></td>
  </tr>
  <tr>
    <td>วันที่เพิ่ม</td>
