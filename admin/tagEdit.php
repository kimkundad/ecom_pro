...
<div style="float:right;">
  ...
  <tr>
    <td colspan="2">
<form action="process/tag/tagUpdate.php" method="post" name="tag">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="100">ชื่อแท็ก</td>
    <td><input name="name" type="text" required value="<?=$row['name']?>"/></td>
  </tr>
  <tr>
    <td>ลิงค์</td>
    <td><input name="link" type="text" value="<?=$row['link']?>" style="width:300px;" required/></td>
  </tr>
  <tr>
    <td>วันที่เพิ่ม</td>
    <td><input name="register_date" type="text" value="<?=substr($row['insert_date'],0,16)?>" readonly="readonly" style="background:#fafafa;"/></td>
  </tr>
  <tr>
    <td>แก้ไขล่าสุด</td>
