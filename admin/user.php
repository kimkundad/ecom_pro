...
<title>ระบบหลังร้าน - ผู้ใช้</title>
<!-- InstanceEndEditable -->
...
<table class="data" align="center" cellpadding="10" cellspacing="0" >
  <tr>
    <th class="header" colspan="2" >เพิ่มผู้ใช้ใหม่</th>
  </tr>
  <tr>
    <td colspan="2">
<form action="process/user/userInsert.php" method="post" name="user">
...
?>
  <tr>
    ...
    <td align="center" style="background:#f9f9f9">
      <a href="userEdit.php?id=<?=base64_encode($row['id'])?>"><img src="image/icon-pencil.png" class="action" title="เปลี่ยนรหัสผ่าน"/></a>
      <a href="process/user/userDelete.php?id=<?=base64_encode($row['id'])?>" onclick="return confirm('ลบผู้ใช้ <?=$row['username']?> ?')"><img src="image/icon-bin.png"class="action" title="ลบ"/></a>
    </td>
  </tr>
<?
  }
