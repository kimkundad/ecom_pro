<?
if(empty($_REQUEST['id'])){echo"<script>window.location='user.php';</script>";exit;}
session_start();
?>
...
<div style="float:right;">
  ...
  <tr>
    <td colspan="2">
<form action="process/user/userUpdate.php" method="post" name="user">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="100">ชื่อผู้ใช้</td>
    <td><input type="text" name="username" value="<?=$row['username']?>" readonly="readonly" style="background:#fafafa;"/></td>
  </tr>
  <tr>
    <td>รหัสผ่านใหม่</td>
