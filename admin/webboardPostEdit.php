<?
if(empty($_REQUEST['id'])){echo"<script>window.location='webboard.php';</script>";}
session_start();
?>
...
<table class="data" style="margin-top:10px;" align="center" cellpadding="10" cellspacing="0">
  ...
  <tr>
    <td colspan="2">
<form action="process/webboard/postUpdate.php" method="post" name="webboard" >
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td width="100">หัวข้อ</td>
    <td><input name="subject" type="text" style="width:800px;" value="<?=$row['subject']?>"/></td>
  </tr>
  <tr>
    <td>เนื้อหา</td>
