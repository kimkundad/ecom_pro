...
<meta name="description" content="<?=mb_substr(strip_tags($rowSetting['contact_us']),0,200,'UTF-8')?>"/>
<!-- InstanceEndEditable -->
<? 
...
<table class="box" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <th class="header" style="text-align:left;">ติดต่อเรา</th>
  </tr>
  <tr>
    <td>
<form name="contactUs" method="post" action="process/contactUs.php">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="100">หัวข้อ</td>
    <td>
      <input type="text" name="subject"required style="width:450px;max-width:450px;"/>
...
<?
if($rowSetting['contact_us']!=""){
?>
      <hr/>
      <?=$rowSetting['contact_us']?>
<?
}
?>
    </td>
