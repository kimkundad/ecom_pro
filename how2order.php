...
<title>วิธีการสั่งซื้อ | <?php=$rowSetting['title']?></title>
<meta name="description" content="<?php=mb_substr(strip_tags($rowSetting['order']),0,200,'UTF-8')?>"/>
<!-- InstanceEndEditable -->
<?php
...
<table class="box" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <th class="header" style="text-align:left;">วิธีการสั่งซื้อ</th>
  </tr>
  <tr>
    <td><?php=$rowSetting['order']?></td>
  </tr>
</table>
