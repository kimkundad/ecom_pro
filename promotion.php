...
<title>โปรโมชั่น | <?php=$rowSetting['title']?> </title>
<meta name="description" content="<?php=mb_substr(strip_tags($rowSetting['promotion']),0,200,'UTF-8')?>"/>
<!-- InstanceEndEditable -->
<?php
...
<table class="box" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <th class="header" style="text-align:left;">โปรโมชั่น</th>
  </tr>
  <tr>
    <td>
      <?php=$rowSetting['promotion']?>
    </td>
  </tr>
</table>
<!-- InstanceEndEditable -->
